...
class AuthControllerTest {
    ...
    void shouldReturn200OnSuccessfulLogin() throws Exception {
        ...
        UserDto userDto = new UserDto(1L, "admin@sportsevents.com", List.of("ADMIN"));
        LoginResult result = new LoginResult("jwt.mock.token", "Bearer", 86400L, userDto);
    ...
    void shouldReturn401WhenAccountInactive() throws Exception {
        ...
        when(loginUseCase.execute(any(LoginCommand.class)))
                .thenThrow(new UserInactiveException("User account is inactive"));
        ...
        mockMvc.perform(post("/api/v1/auth/login")
                ...
                .andExpect(jsonPath("$.error.details", is("User account is inactive")));
    }
